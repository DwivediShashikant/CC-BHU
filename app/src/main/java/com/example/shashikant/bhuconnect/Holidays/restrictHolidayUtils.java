...
import com.example.shashikant.bhuconnect.Holidays.HolidaysUtils;
import com.example.shashikant.bhuconnect.Holidays.holidays;
import com.example.shashikant.bhuconnect.Holidays.rHolidayList;
...
public class restrictHolidayUtils {
    static ArrayList<holidays> arrayList = new ArrayList<>();
    public static final String LOG_TAG = HolidaysUtils.class.getSimpleName();
    public static ArrayList<holidays> fetchHolidays(String requestUrl){
        ...
        try {
            ...
            if(json_len>0){
                for(int i=0;i<json_len;i++){
                    ...
                    rHolidayList.rList.add(new holidays(HolidayName,Date,Week,Days));
                }
            }
